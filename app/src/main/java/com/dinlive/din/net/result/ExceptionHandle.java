...
public class ExceptionHandle {
    ...
    public static ResponseException handleException(Throwable e) {
        ResponseException ex;//转换成ResponseException,根据状态码判定错误信息
        if (e instanceof ServerException) {
            ServerException serverException = (ServerException) e;
            ex = new ResponseException(e, serverException.code);
            ex.message = serverException.message;
            return ex;
        } else if (e instanceof HttpException) {
            HttpException httpException = (HttpException) e;
            ex = new ResponseException(e, ERROR.HTTP_ERROR);//传入状态码，根据状态码判定错误信息
    ...
    public static class ServerException extends RuntimeException {
        ...
        public ServerException(Throwable throwable, String message, int code) {
            super(throwable);
            this.code = code;
