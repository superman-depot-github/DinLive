 ...
 * @ClassName BGASortableNinePhotoLayout
 * @Description 拖拽排序九宫格图片控件
 */
    ...
    private class ItemTouchHelperCallback extends ItemTouchHelper.Callback {
        ...
        public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
            if (actionState != ACTION_STATE_IDLE) {
                ...
                ((BGARecyclerViewHolder) viewHolder).getViewHolderHelper().getImageView(R.id.iv_item_nine_photo_photo).setColorFilter(Color.parseColor("#4D000000"));
            }
