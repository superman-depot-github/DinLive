 ...
 * @ClassName BGAHeaderAndFooterAdapter
 * @Description 该类参考的 https://github.com/hongyangAndroid/baseAdapter/blob/master/baseadapter-recyclerview/src/main/java/com/zhy/adapter/recyclerview/wrapper/HeaderAndFooterWrapper.java
 */
