package com.dinlive.din.person.widget.loopview;
...
public class DataWheelView extends LinearLayout {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        tv_mooth = (TextView) findViewById(R.id.tv_mooth);
     ...
     * @param isShow
     */
    public void showDescribe(Boolean isShow) {
        if (!isShow) {
            tv_year.setVisibility(GONE);
            tv_mooth.setVisibility(GONE);
