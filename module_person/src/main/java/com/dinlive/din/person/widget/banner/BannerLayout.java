package com.dinlive.din.person.widget.banner;
...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        int indicatorSelectedColor = a.getColor(R.styleable.BannerLayout_indicatorSelectedColor, Color.BLUE);
        int indicatorUnselectedColor = a.getColor(R.styleable.BannerLayout_indicatorUnselectedColor, Color.GRAY);
        int indicatorRadius = a.getDimensionPixelSize(R.styleable.BannerLayout_indicatorRadius, dp2px(3));

        int shapeType = a.getInt(R.styleable.BannerLayout_indicatorShapeType, 0);
        int indicatorRectangleWidth = a.getDimensionPixelSize(R.styleable.BannerLayout_indicatorRectangleWidth, dp2px(3));
        int indicatorRectangleHigth = a.getDimensionPixelSize(R.styleable.BannerLayout_indicatorRectangleHigth, dp2px(1));
        if (mSelectedDrawable == null) {
            ...
            if (shapeType == 0) {
                ...
                selectedGradientDrawable.setSize(dp2px(indicatorRadius), dp2px(indicatorRadius));
                selectedGradientDrawable.setCornerRadius(dp2px(indicatorRadius));
            } else {
                selectedGradientDrawable.setShape(GradientDrawable.RECTANGLE);
                selectedGradientDrawable.setColor(indicatorSelectedColor);
                selectedGradientDrawable.setSize(dp2px(indicatorRectangleWidth), dp2px(indicatorRectangleHigth));
            }
        ...
        if (mUnselectedDrawable == null) {
            ...
            if (shapeType == 0) {
                ...
                unSelectedGradientDrawable.setSize(dp2px(indicatorRadius), dp2px(indicatorRadius));
                unSelectedGradientDrawable.setCornerRadius(dp2px(indicatorRadius));
            } else {
                unSelectedGradientDrawable.setShape(GradientDrawable.RECTANGLE);
                unSelectedGradientDrawable.setColor(indicatorUnselectedColor);
                unSelectedGradientDrawable.setSize(dp2px(indicatorRectangleWidth), dp2px(indicatorRectangleHigth));
            }
            mUnselectedDrawable = new LayerDrawable(new Drawable[]{unSelectedGradientDrawable});
        }

        indicatorMargin = a.getDimensionPixelSize(R.styleable.BannerLayout_indicatorSpace, dp2px(0));
        int marginLeft = a.getDimensionPixelSize(R.styleable.BannerLayout_indicatorMarginLeft, dp2px(0));
        int marginRight = a.getDimensionPixelSize(R.styleable.BannerLayout_indicatorMarginRight, dp2px(0));
        int marginBottom = a.getDimensionPixelSize(R.styleable.BannerLayout_indicatorMarginBottom, dp2px(0));
        int marginTop = a.getDimensionPixelSize(R.styleable.BannerLayout_indicatorMarginTop, dp2px(0));

        int gravityTopOrDown = Gravity.BOTTOM;
        int gravityLeftORight = Gravity.CENTER;
        int indicatorGravity = a.getInt(R.styleable.BannerLayout_indicatorGravity, 5);
        switch (indicatorGravity) {
            //上左
            case 0:
                gravityTopOrDown = Gravity.TOP;
                gravityLeftORight = Gravity.LEFT;
                break;
            //上右
            case 1:
                gravityTopOrDown = Gravity.TOP;
                gravityLeftORight = Gravity.RIGHT;
                break;
            //上中
            case 2:
                gravityTopOrDown = Gravity.TOP;
                gravityLeftORight = Gravity.CENTER;
                break;
            //下左
            case 3:
                gravityTopOrDown = Gravity.BOTTOM;
                gravityLeftORight = Gravity.LEFT;
                break;
            //下右
            case 4:
        ...
        params.gravity = gravityTopOrDown | gravityLeftORight;
